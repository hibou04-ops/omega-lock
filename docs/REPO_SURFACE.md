...
0.3.0 release on 2026-06-06. This is an inspection document only; it does not
...
| --- | --- |
| `src/omega_lock/__init__.py` | `__version__ = "0.3.0"` |
| `README.md` | Current local package version badge and conditional install examples use `0.3.0`; PyPI publication status is explicitly not asserted. |
| `README_KR.md` | Current local package version badge and conditional install examples use `0.3.0`; PyPI publication status is explicitly not asserted. |
| `EASY_README.md` | Current local package version badge and conditional install examples use `0.3.0`; PyPI publication status is explicitly not asserted. |
| `EASY_README_KR.md` | Current local package version badge and conditional install examples use `0.3.0`; PyPI publication status is explicitly not asserted. |
...
| Bundled Python `pyproject.toml` read | Verified | Printed `omega-lock 0.3.0`. |
| Bundled Python source import with `PYTHONPATH=src` | Verified | Printed `0.3.0`. |
...
No local `v0.3.0` tag exists yet; it is created during the 0.3.0 release flow.
