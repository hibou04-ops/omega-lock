...
3. 계약서에 추가 요청할 표현 (한국어 샘플):
   > 「본 계약 체결일 이전에 작성된 별첨 1의 발명·저작물(omega-lock, Antemortem, antemortem-cli — 각 GitHub URL 및 tag pre-employment-ip-snapshot-2026-04-28 참조)은 피용자의 기존 지식재산권으로 인정되며, 본 계약의 직무발명·업무상 저작물 양도 조항의 적용 대상에서 제외된다.」
...
# 다른 두 repo도 동일하게:
# C:/Users/hibou/Antemortem
# C:/Users/hibou/antemortem-cli
```
...
- 새로운 repo 추가 시 → 위 3개 repo URL 목록 갱신
